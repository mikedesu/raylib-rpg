...
public:
    ...
    bool init();
    bool handle_dungeon_move_pos(const entity_id id, const Vector2 c_pos, const Vector2 t_pos);
    ...
    void increase_lighting_at(const Vector2 loc, const int light_level, const int dist);
    void decrease_lighting_at(const Vector2 loc, const int light_level, const int dist);
