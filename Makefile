CC=g++
OBJ_FILES=Game.o Sprite.o Scene.o TitleScene.o GameplayScene.o GameoverScene.o PopupManager.o  Tile.o Dungeon.o DungeonFloor.o DungeonEvent.o Entity.o MessagePane.o
...
DungeonFloor.o: DungeonFloor.cpp
	$(CC) $^ $(FLAGS) -c -o $@
DungeonEvent.o: DungeonEvent.cpp
	$(CC) $^ $(FLAGS) -c -o $@
Entity.o: Entity.cpp
	$(CC) $^ $(FLAGS) -c -o $@
MessagePane.o: MessagePane.cpp
	$(CC) $^ $(FLAGS) -c -o $@
main.o: main.cpp
	$(CC) $^ $(FLAGS) -c -o $@
